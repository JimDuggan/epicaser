...
Now, we generate a case list. This generates outputs showing the progress as synthetic data is created for each individual.
...
We can double-check the summaries to ensure they match the aggregated values. We can see that two 80-99 year olds were infected on the 5th, and this tallies with teh early age cohort stratification.
```{r}
# Check summaries
epi_sum <- epi_cases %>% 
